...
public class CreditCardNumberTest {
    ...
    @Test
    public void throwsInvalidArgumentExceptionWhenCvcNumberTooShort() {
        assertThrows(IllegalArgumentException.class, () -> {
            new CreditCardNumber("7321876532147654", "12");
        });
    }

    @Test
    public void throwsInvalidArgumentExceptionWhenCvcNumberTooLong() {
        assertThrows(IllegalArgumentException.class, () -> {
            new CreditCardNumber("7321876532147654", "1234");
        });
    }

    @Test
    public void throwsInvalidArgumentExceptionWhenCvcNumberNotANumber() {
        assertThrows(IllegalArgumentException.class, () -> {
            new CreditCardNumber("7321876532147654", "abc");
        });
    }
}
